...
from de.thb.content_graph.graph.explore_path import ExplorePath
...
def main():
    ...
    for disease in diseases:
        ...
        content_paths: list[ExplorePath] = list(map(lambda p: ExplorePath.with_path(disease, p), explorer.paths))
        ...
        filtered_content_paths: list[ExplorePath] = list(filter(lambda p: p.duration >= FILTER_TIME and
