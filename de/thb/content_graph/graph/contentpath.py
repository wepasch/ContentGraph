...
from de.thb.content_graph.graph.constants import KEY_DISEASE, KEY_ACTIVITIES, KEY_FINISHED, KEY_DURATION_MIN, \
...
class ContentPath:
    ...
    @classmethod
    def with_path(cls, disease: Disease, activitiy_uids: list[str]) -> 'ContentPath':
        content_path: ContentPath = ContentPath(disease)
    ...
    def duration(self) -> int:
        ...
        for a in self.activities:
            duration += a.duration_min if a.duration_min is not None else 0
        return duration
